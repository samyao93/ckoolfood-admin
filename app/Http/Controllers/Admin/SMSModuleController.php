...
class SMSModuleController extends Controller
{
    ...
    public function sms_update(Request $request, $module)
    {
        if ($module == 'twilio_sms') {
            BusinessSetting::updateOrCreate(['key' => 'twilio_sms'], [
                'key' => 'twilio_sms',
                'value' => json_encode([
            ...
            BusinessSetting::updateOrCreate(['key' => 'nexmo_sms'], [
                'key' => 'nexmo_sms',
                'value' => json_encode([
                    'status' => $request['status'],
            ...
            BusinessSetting::updateOrCreate(['key' => '2factor_sms'], [
                'key' => '2factor_sms',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
            ...
            BusinessSetting::updateOrCreate(['key' => 'msg91_sms'], [
                'key' => 'msg91_sms',
                'value' => json_encode([
                    'status' => $request['status'],
