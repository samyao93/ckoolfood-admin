                ...
                <div class="row align-items-md-center">
                    ...
                    <div class="col-md-6">
                        <span class="d-block mb-1">
                            ...
                            <strong class="text--title">{{Carbon\Carbon::parse($campaign->start_date)->locale(app()->getLocale())->translatedFormat('d M Y')}}</strong>
                        </span>
                        <span class="d-block mb-1">
                            ...
                            <strong class="text--title">{{ Carbon\Carbon::parse($campaign->end_date)->locale(app()->getLocale())->translatedFormat('d M Y') }}</strong>
                        </span>
                        <span class="d-block mb-1">
                            {{translate('messages.available')}} {{translate('messages.time')}} {{translate('messages.starts')}} :
                            <strong class="text--title">{{Carbon\Carbon::parse($campaign->start_time)->locale(app()->getLocale())->translatedFormat(config('timeformat'))}}</strong>
                        </span>
                        <span class="d-block">
                            {{translate('messages.available')}} {{translate('messages.time')}} {{translate('messages.ends')}} :
                            <strong class="text--title">{{Carbon\Carbon::parse($campaign->end_time)->locale(app()->getLocale())->translatedFormat(config('timeformat'))}}</strong>
                        </span>
                    </div>
                </div>
            </div>
