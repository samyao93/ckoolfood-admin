                ...
                <div class="card-body">
                    <div class="row g-3 lang_form default-form" id="default-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input maxlength="30" type="text"  name="title[]" value="{{ $news_letter_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter Title')}}">
                    ...
                    <div class="row g-3 d-none lang_form" id="{{$lang}}-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" maxlength="30" name="title[]" value="{{ $news_letter_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter Title')}}">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <input type="text" maxlength="70" name="sub_title[]" value="{{ $news_letter_sub_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter Title')}}">
                        </div>
                    </div>
                    @empty
                    @endforelse
